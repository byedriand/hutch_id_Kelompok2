...
class ApiService {
  ...
  Future<Map<String, dynamic>> login(String email, String password) async {
    try {
      print('🔐 Login attempt: $email to ${AppConfig.apiBaseUrl}/login');
  ...
  Future<Pelanggan?> getPelangganDetail(int id) async {
    try {
      ...
      print('Error fetching pelanggan detail: $e');
      return null;
    }
  }
  ...
  Future<Produk?> getProdukDetail(int id) async {
    try {
      ...
      print('Error fetching produk detail: $e');
      return null;
    }
  }
