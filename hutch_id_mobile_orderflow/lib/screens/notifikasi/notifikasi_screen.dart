...
class _NotifikasiScreenState extends State<NotifikasiScreen>
  ...
  List _getFilteredNotifications(List notifikasiList) {
  ...
  Widget _buildNotifikasiCard(context, notifikasi) {
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: _getColorByType(notifikasi.tipe).withOpacity(0.15),
