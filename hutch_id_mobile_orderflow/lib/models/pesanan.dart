  ...
  factory Pesanan.fromJson(Map<String, dynamic> json) {
    ...
    if (json['tanggal_pesanan'] != null) {
      try {
        ...
        print('Error parsing tanggal_pesanan: $e');
      }
    }
    ...
    if (json['tanggal_pengiriman'] != null) {
      try {
        ...
        print('Error parsing tanggal_pengiriman: $e');
      }
    }
    ...
    if (json['tanggal_dikirim'] != null) {
      try {
        ...
        print('Error parsing tanggal_dikirim: $e');
      }
    }
    ...
    if (json['pelanggan'] != null) {
      if (json['pelanggan'] is Map) {
        try {
          ...
          print('Error parsing pelanggan object: $e');
        }
      }
    }
