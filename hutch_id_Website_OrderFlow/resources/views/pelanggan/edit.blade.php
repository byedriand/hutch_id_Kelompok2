...
<style>
    ...
    @keyframes fadeInUp {
        ...
        border-top: 1px solid rgba(219, 229, 241, 0.5);
    }
    ...
    .btn-submit.primary {
        ...
        color: white;
        box-shadow: 0 10px 24px rgba(45, 125, 210, 0.25);
    }

    .btn-submit.primary:hover {
        transform: translateY(-2px);
        box-shadow: 0 14px 32px rgba(45, 125, 210, 0.35);
        background: linear-gradient(135deg, #1e5aa8, #154399);
    }
...
<div class="form-header">
    <div class="form-header-content">
        <h2>Edit Pelanggan <span class="info-badge">{{ $pelanggan->nama }}</span></h2>
        <p>Perbarui informasi pelanggan yang sudah tersimpan.</p>
    </div>
</div>
    ...
    <form action="{{ route('pelanggan.update', $pelanggan) }}" method="POST">
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama" value="{{ old('nama', $pelanggan->nama) }}" class="form-control @error('nama') is-invalid @enderror" placeholder="Contoh: PT. Jaya Sentosa" required>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="telepon" value="{{ old('telepon', $pelanggan->telepon) }}" class="form-control @error('telepon') is-invalid @enderror" placeholder="0812xxxxxxx" required>
            ...
            <div class="form-group">
                ...
                <textarea name="alamat" class="form-textarea @error('alamat') is-invalid @enderror" placeholder="Contoh: Jl. Merdeka No. 123, Jakarta Selatan" required>{{ old('alamat', $pelanggan->alamat) }}</textarea>
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn-submit primary">
                <i class="fas fa-check"></i>Perbarui Pelanggan
            </button>
        </div>
    </form>
</div>
